...
<ol class="paging" >
	...
	<c:otherwise>
		<li><a href="${pageContext.request.contextPath}/user/usercShop?name=${name}&cPage=${nowPage-pagePerBlock}">이전으로</a></li>
	</c:otherwise>
	</c:choose>
 	...
 	<c:choose>
		...
		<c:when test="${totalPage > (nowPage+pagePerBlock)}">
			<li><li><a href="${pageContext.request.contextPath}/user/usercShop?name=${name}&cPage=${nowPage+pagePerBlock }">다음으로</a></li>
		</c:when>
		<c:otherwise>
     		<li><li><a href="${pageContext.request.contextPath}/user/usercShop?name=${name}&cPage=${totalPage }">다음으로</a></li>
		</c:otherwise>
 	</c:choose>
</ol>
</td>
